import type { GetContextValue, Middleware, RequestContext, ContextWithEntry } from '@remix-run/fetch-router';
...
type RequireAuthContextTransform<identity> = <context extends RequestContext<any, any>>(context: context) => ContextWithEntry<context, {
    key: typeof Auth;
    value: ResolvedGoodAuth<context, identity>;
    property: 'auth';
}>;
/**
