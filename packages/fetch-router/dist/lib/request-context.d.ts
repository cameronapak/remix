...
type ContextProperty<entries extends ContextEntries, entry extends ContextEntry> = {
    readonly [property in ContextEntryProperty<entry>]: ResolveEntryValue<entries, entry['key'], entry['value']>;
};
type ContextPropertiesFrom<entries extends ContextEntries, allEntries extends ContextEntries> = entries extends readonly [...infer rest extends ContextEntries, infer last extends ContextEntry] ? Simplify<Omit<ContextPropertiesFrom<rest, allEntries>, ContextEntryProperty<last>> & ContextProperty<allEntries, last>> : {};
/**
 * Resolves the direct request-context properties installed by context entries.
 */
export type ContextProperties<entries extends ContextEntries> = ContextPropertiesFrom<entries, entries>;
...
export declare class RequestContext<params extends Record<string, any> = {}, entries extends ContextEntries = []> {
     ...
     */
    set: <key extends object>(key: key, value: ContextValue<key>, options?: ContextPropertyOptions<string> | undefined) => void;
    /**
