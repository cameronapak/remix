 ...
 */
export declare const Renderer: import("../../../fetch-router/src/lib/request-context").ContextKey<AnyRenderer>;
 ...
 */
export declare function renderWith<const renderer extends AnyRenderer>(createRenderer: RendererFactory<renderer>): Middleware<RendererContextEntry<renderer>>;
export {};
